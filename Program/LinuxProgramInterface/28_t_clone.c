...
int main(int argc, char* argv[])
{
    ...
    /* Ignore CHILD_SIG, in case it is a signal whose default is to terminate the prcess;
       but don't ignore SIGCHLD (which is ignored by default), since that would prevent the
    ...
    /* Parent falls through to here. Wait for child; __WCLONE is need for child
       notifying with signal other than SIGCHLD. */
