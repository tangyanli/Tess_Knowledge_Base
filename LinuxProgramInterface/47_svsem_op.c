/* Performing System V semaphore operations with semop */
...
/* Parse comma-delimited operation in 'arg', returning them in the array 'sops'.*/
/* Return number of operations as function result */
