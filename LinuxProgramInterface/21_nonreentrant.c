...
int main(int argc, char* argv[])
{
	...
	/* Repeatedly call crypt() using argv[1]. If interrupted by a signal handler, then the static */
	/* storage returned by crypt() will be overwritten by the results of encrypting argv[2], */
